...
### Tech Stack
My primary focus is **C++**, and **Rust**.
In field i am capable of the folling:
...
*   **Csharp**: Basic knowledge and some advanced features are well known to me and I am able to impelemnt them in projects.
*   **Linux**: I am pretty experienced with many diffrent distros and architectures
*   **Windows**: A lot of experience developing stuff using windows as OS, as well as extensive knowledge in using the WLS Subsystem.
### Projects
